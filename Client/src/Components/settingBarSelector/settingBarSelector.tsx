    ...
    return (
        <div className={styles.sortGridParams}>
            <div className={styles.selectContainer}>
                ...
                >
                    <option defaultValue={''} className={styles.selOption}>
                        Default
                    </option>
                    <option value={'name'} className={styles.selOption}>
                        Name
                    </option>
                    <option value={'domain'} className={styles.selOption}>
                        Domain
                    </option>
                    <option value={'email'} className={styles.selOption}>
                        Email
                    </option>
                    <option value={'phone'} className={styles.selOption}>
                        Phone
                    </option>
                </select>
            </div>
            <div className={styles.selectContainer}>
                ...
                >
                    ...
                    <option value={'DESC'} className={styles.selOption}>
                        Descending order
                    </option>
                    <option value={'ASC'} className={styles.selOption}>
                        Ascending order
                    </option>
                </select>
            </div>
