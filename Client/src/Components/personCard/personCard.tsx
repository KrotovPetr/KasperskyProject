...
const PersonCard:FC<any> = (props) => {
    ...
    return (
        <div className={`${isChecked ? styles.personCardChecked : ""} ${styles.personCard}`}>
            <div className={styles.topLevel}>
                <input type={"checkbox"} onChange={():void=>{changeCheck(!isChecked)}} />
                {!isChecked && <img src={Upload} className={styles.uploadImg} alt={"upload"}/>}
            </div>
